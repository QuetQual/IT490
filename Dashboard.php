...
if (!isset($_SESSION['email'])) {
    ...
    @$fetchUser = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM users WHERE email = '$_SESSION[email]'"));
    //echo "SELECT * FROM users WHERE email = '$_SESSION[email]'";
}
?>
...
<body>
    ...
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="#"><?= @$fetchUser['username']; ?></a>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2"> Welcome <?= @$fetchUser['username']; ?></h1>
                </div>
            </main>
        </div>
    </div>
